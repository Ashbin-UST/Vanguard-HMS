...
/**
 * Shared confirm dialog, mounted once at the app root and driven by
 * `useConfirmModal`. Mirrors the Angular ConfirmModalComponent: backdrop press
 * cancels ("Stay"), the two footer buttons resolve the awaiting promise.
 */
