...
const QUICK_ACTIONS = [
  { label: "Book appointment", icon: "calendar-outline" as const, href: "/book-appointment" },
...
export default function HomeScreen() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      // Only future-dated bookings, soonest first
      const now = Date.now();
      ...
      // Leave defaults; the profile/appointments screens surface errors in detail
    } finally {
      setLoading(false);
    }
  }, []);
